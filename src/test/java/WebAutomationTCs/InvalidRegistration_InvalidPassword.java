...
public class InvalidRegistration_InvalidPassword {
    ...
    @Description("Fill the Registration Form with Invalid Password")
    @Test(priority = 3)
    public void fillRegistrationForm_InvalidPassword() throws IOException, ParseException {
        ...
        registerFormPage.password_Set((String) registrationData.get("Invalidpassword"));
        ...
        Assert.assertEquals("Password should not be empty / length be between 7 to 12", AlertMessage);
    }
